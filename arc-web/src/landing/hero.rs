    ...
    view! {
        <section style="padding: 104px 24px 80px;">
            <div style="max-width: 1200px; margin: 0 auto;">
                <div class="label-sm" style="color: var(--primary-60); margin-bottom: 24px;">
                    "AI-INFRASTRUCTURE.DEPLOYMENT.PLATFORM"
                </div>
                <h1 class="headline-display" style="color: var(--secondary); max-width: 800px; margin-bottom: 24px;">
                    "Deploy at the "
                    <span style="color: var(--primary);">"speed of thought."</span>
                </h1>
                <p class="body-lg" style="color: #9ca3af; max-width: 560px; margin-bottom: 40px;">
