...
pub fn LandingPage() -> impl IntoView {
    view! {
        <div style="background: var(--tertiary); color: var(--secondary); min-height: 100vh;">
            // Promo bar
            <div style="background: #111; border-bottom: 1px solid #1f1f1f; padding: 8px 0;">
            ...
            // Top nav
            <nav style="display: flex; align-items: center; justify-content: space-between; max-width: 1200px; margin: 0 auto; padding: 20px 24px;">
                <div class="label-lg" style="font-weight: 600; font-size: 18px;">
                    "◆ ARC"
                </div>
                <div style="display: flex; align-items: center; gap: 40px;">
                    <a class="label-md" style="color: #9ca3af;" href="#">"Docs"</a>
                    <a class="label-md" style="color: #9ca3af;" href="#">"Pricing"</a>
                    <a class="label-md" style="color: #9ca3af;" href="#">"GitHub"</a>
            ...
            <div style="background: var(--primary);">
                <div style="max-width: 1200px; margin: 0 auto; padding: 104px 24px; text-align: center;">
                    <h2 class="headline-display" style="color: var(--tertiary); margin-bottom: 24px;">
                        "Ready to deploy?"
                    </h2>
                    <button class="btn btn-sm" style="background: var(--tertiary); color: var(--secondary);" on:click=move |_| navigate(Route::Overview)>
                        "Get Started →"
                    </button>
                </div>
            </div>
